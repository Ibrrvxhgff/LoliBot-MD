...
if (!isBotAdmin) return await conn.sendMessage(m.chat, {text: `*「 تم اكتشاف رابط 」*\n\n${userTag}، لقد أرسلت رابطًا ولكن لا يمكنني إزالتك لأنني لست مشرفًا.`, mentions: [m.sender]}, { quoted: m });
await conn.sendMessage(m.chat, { text: `*「 تم اكتشاف رابط 」*\n\n${userTag}، لقد خالفت قوانين المجموعة وسيتم إزالتك.`, mentions: [m.sender] }, { quoted: m });
try {
