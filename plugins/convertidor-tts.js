...
if (!args.length && !m.quoted?.text) return m.reply(`*الاستخدام:* ${usedPrefix + command} <صوت|لغة> <نص>\n\n*الأصوات:* anonymous, robot, grave, aguda, niño\n*اللغات:* ar, es, en, pt, fr, etc.\n\nمثال:\n${usedPrefix + command} anonymous مرحبًا\n${usedPrefix + command} ar Hello`)
m.react("🎙️")
...
if (!text) return m.reply("⚠️ اكتب نصًا لتحويله إلى صوت.")
try {
